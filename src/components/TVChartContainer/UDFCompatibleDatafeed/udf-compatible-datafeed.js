...
var UDFCompatibleDatafeed = /** @class */ (function (_super) {
    ...
    function UDFCompatibleDatafeed(datafeedURL, wsMode, updateFrequency) {
        ...
        _this = _super.call(this, datafeedURL, quotesProvider, requester, wsMode, updateFrequency) || this;
        return _this;
    }
