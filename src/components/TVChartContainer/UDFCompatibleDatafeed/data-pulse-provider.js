...
var DataPulseProvider = /** @class */ (function () {
    ...
    DataPulseProvider.prototype.subscribeBars = function (symbolInfo, resolution, newDataCallback, listenerGuid, onResetCacheNeededCallback) {
    ...
    DataPulseProvider.prototype._updateDataForSubscriber = function (listenerGuid) {
        ...
        if (subscriptionRecord.nextTime) {
            rangeStartTime = subscriptionRecord.nextTime;
        }
    ...
    DataPulseProvider.prototype._onSubscriberDataReceived = function (listenerGuid, result) {
        ...
        if (bars.length === 0) {
            ...
            subscriptionRecord.nextTime = meta.noData ? meta.nextTime : null;
            return;
        }
        subscriptionRecord.nextTime = null;
