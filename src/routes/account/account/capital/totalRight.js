...
class Index extends Component {
    render() {
        const { dataSource, currencyType, positionHavaListData } = this.props;
        let tooltopValue =  0;
        ...
        return (
            <div className="totalRight">
                <div className="marginDisplay" style={{height:170}}>
                    ...
                    <div className="rowRight">
                        <div style={{ width: "100%" }} className="dataBar transaction_back">
                            <div className='borderColorGreen' style={{minWidth:'1px', width: unrealisedPnlWidth + "%", marginLeft: (100 - unrealisedPnlWidth) + '%', height: '100%' }}></div>
                        </div>
                        <div className='margin_label'>
...
export default connect(({ margin, orderList }) => {
